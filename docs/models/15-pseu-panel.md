...
This panel has no PCB and no patch cable of its own. Its single annunciator is wired across to a PCB on the **LE Devices and ELT Panel**, where it takes header **4** — that PCB's cable goes to socket **D0** on **Overhead_1a**.
