...
Printed graphics for the panel faces and annunciators.
...
> **Tip**
> Order at least **two copies** of each PDF file. During multiple prints, it is possible that one area of a sheet will be perfectly sharp while another area may appear slightly blurred. Having a second copy allows you to choose the best sections from each print if necessary.
